...
<p align="left">✨ Criando bugs desde 2023.<br>📚 Atualmente estou desenvolvendo meus conhecimentos em Python, aprimorando técnicas em Power BI e me aprofundando em R para realizar análise de dados.<br>🎯tendo como objetivo em análise de regressão, publicar painéis esclarecedores e construir uma base sólida em análise de dados para tomada de decisões.</p>
